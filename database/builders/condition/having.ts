import IConditionBuilder, {
	...
	TOperator,
	TBaseValue,
} from 'silviePath/database/builders/condition/index';

import QueryBuilder from 'silviePath/database/builders/query';
...
export default class HavingConditionBuilder implements IConditionBuilder {
	...
	havingLike(column: TColumn | QueryBuilder, value: TValue): HavingConditionBuilder {
		return this.baseHaving('like', 'and', column, value);
	}

	orHavingLike(column: TColumn | QueryBuilder, value: TValue): HavingConditionBuilder {
		return this.baseHaving('like', 'or', column, value);
	}

	havingNotLike(column: TColumn | QueryBuilder, value: TValue): HavingConditionBuilder {
		return this.baseHaving('not like', 'and', column, value);
	}

	orHavingNotLike(column: TColumn | QueryBuilder, value: TValue): HavingConditionBuilder {
